...
// Use cursor color from Ghostty config (cursor-color setting)
#define TRAIL_COLOR iCurrentCursorColor
#define TRAIL_COLOR_ACCENT (iCurrentCursorColor * 0.7)  // Slightly darker version
